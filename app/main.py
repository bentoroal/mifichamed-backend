...
from app.routers import auth, conditions, medications, symptoms, user_conditions, user_symptoms, user_symptom_daily, condition_treatments, dashboard, user_profile, user_surgeries, user_allergies, allergies, surgeries, report, exam_results
...
origins = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://master.d3b2r7v6uor1t7.amplifyapp.com"
]
